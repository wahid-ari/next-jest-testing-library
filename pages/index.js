...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Next Test Jest React Testing Library" />
  ...
  expect(button).toBeDisabled()
          ...
          <div className="my-8 pt-14" id="linkbutton">
            ...
            <LinkButton href="#" aria-label="Home page" title="A link to start over">Link Button</LinkButton><br /><br />
            <LinkButton href="#" pills>Link Button Pills</LinkButton>
          </div>

          <div className="my-8 pt-14" id="linkbuttonoutline">
            <Heading.h5 className="mb-2 italic">link button outline</Heading.h5>
            <LinkButtonOutline href="#" aria-label="Home page" title="A link to start over">Link Button Outline</LinkButtonOutline><br /><br />
            <LinkButtonOutline href="#" pills>Link Button Outline Pills</LinkButtonOutline>
          </div>

          <div className="my-8 pt-14" id="alert">
            <Heading.h5 className="mb-2 italic">alert</Heading.h5>
            <Alert>Alert</Alert>
            <Alert pills>Alert Pills</Alert>
            <Alert large>Alert Large</Alert>
          </div>

          <div className="my-8 pt-14" id="alertoutline">
            <Heading.h5 className="mb-2 italic">alertoutline</Heading.h5>
            <AlertOutline>Alert Outline</AlertOutline>
            <AlertOutline pills>Alert Outline Pills</AlertOutline>
            <AlertOutline large>Alert Outline Large</AlertOutline>
          </div>

          <div className="my-8 pt-14" id="badge">
            <Heading.h5 className="mb-2 italic">badge</Heading.h5>
            <Badge className="mr-3">Badge</Badge>
            <Badge pills className="mr-3">Badge Pills</Badge>
            <Badge large className="mr-3">Badge Large</Badge>
          </div>

          <div className="my-8 pt-14" id="badgeoutline">
            <Heading.h5 className="mb-2 italic">badgeoutline</Heading.h5>
            <BadgeOutline className="mr-3">Badge Outline</BadgeOutline>
            <BadgeOutline pills className="mr-3">Badge Outline Pills</BadgeOutline>
            <BadgeOutline large className="mr-3">Badge Outline Large</BadgeOutline>
          </div>
